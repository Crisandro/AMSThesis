												...
												<td width="30">
													<?php 
														if($row['dev_name']== "Monitor" || $row['dev_name']=="System Unit" || $row['dev_name']=="Mouse" || $row['dev_name']=="Keyboard"){
															echo '<input id="optionsCheckbox" class="uniform_on" name="selector[]" type="hidden" value="<?php echo $id; ?>">';
														}	
														else{
															echo '<input id="optionsCheckbox" class="uniform_on" name="selector[]" type="checkbox" value="<?php echo $id; ?>">';
														}
													?>
												</td>
