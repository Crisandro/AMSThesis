                    ...
                    <div class="block">
                        <div class="navbar navbar-inner block-header">
    		                ...
    		                <div class="block-content collapse in">
    								...
    								<div class="control-group">
    	                                ...
    	                                <div class="controls">
    		                                <select name="dev_id" class="chzn-select"  required/>
        										...
        										?>
        		                                <option value="<?php echo $row['dev_id']; ?>&nbspName&nbsp<?php echo $row['dev_name']; ?>">
                                ...
                                $query = mysql_query("select * from stdevice where dev_serial = '$dev_serial' ")
                                or die(mysql_error());
                                ...
                                <?php
                                    ...
                                    mysql_query("insert into stdevice values(null,'$dev_id','$dev_desc','$dev_serial','$dev_brand','$dev_model','$dev_status','')")
                                    or die(mysql_error());
                                    mysql_query("insert into activity_log (date,username,action) values(NOW(),'$admin_username','Add device Detail id $dev_id')")
                                    or die(mysql_error());
                                ?>
                                <script>
                                    window.location = "device_stocks.php";
